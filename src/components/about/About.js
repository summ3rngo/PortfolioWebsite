...
const [availableHeight, setAvailableHeight] = useState(0);
  ...
  useEffect(() => {
    const updateAvailableHeight = () => {
      ...
      console.log(valuesHeadingHeight);
  ...
  return (
    ...
    <div id="personal-section" className={active==='personal' ? 'display about-sections' : 'about-sections nodisplay' }>
        <Row noGutters className="align-items-center" style={{ height: availableHeight }}>
       ...
       <Row noGutters style={{ height: availableHeight, padding: '0 30px' }}>
                <Col xs={12} md={6} xl={6} className="d-flex align-items-center justify-content-center">
                    <div className='values-container'>
                      <PlanetBullet style={{minWidth: '100px', minHeight: '100px'}}/>
                      <div className='value-text'>
                          <h5> Growth-Mindset </h5>
                          <br></br>
                          <p> Strong belief that hardwork and dedication can further develop an individual's ability and intelligence. Understanding and embracing challenges/rejections
                            is important for growth and innovation.
                          </p>
                      </div>
                    </div>
                </Col>
                ...
                <Col xs={12} md={6} xl={6} className="d-flex align-items-center justify-content-center">
                    <div className='values-container'>
                      ...
                      <div className='value-text'>
                          <h5> Growth-Mindset </h5>
                          <br></br>
                          <p> Strong belief that hardwork and dedication can further develop an individual's ability and intelligence. Understand and embracing challenges/rejections
                            is important for growth and innovation.
                          </p>
                      </div>
                    </div>
